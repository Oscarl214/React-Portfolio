...
export default function Home() {
  return (
    ...
    <p className="text-md py-5 leading-9 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
    ...
    <div className="text-5xl flex justify-center gap-16 py-3 text-white-600 dark:text-white-400">
     <a href='https://www.linkedin.com/in/oscar-l-8371a512a/' target="_blank" alt='LinkedIn'><AiFillLinkedin /></a> 
      <a href='https://github.com/Oscarl214' target="_blank" alt='Github'><AiFillGithub /></a>
     <a href='https://drive.google.com/file/d/17-0lqDk_KMBrRq-iD69BnZaCOB8diu4X/view?usp=drive_link' target="_blank"> <AiOutlineFileText/></a>
    </div>
    <div className="mx-auto bg-gradient-to-b from-blue-300-500 rounded-full w-60 h-60 relative overflow-hidden mt-20 md:h-100 md:w-100">
      <img src="/Me.jpeg" alt="myavator" className="w-full h-full object-cover" />
    </div>
  </div>
  );
}
